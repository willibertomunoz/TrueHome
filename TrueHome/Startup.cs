...
namespace TrueHome
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddDbContext<DataAccess.AppContext>(opt =>
                                              opt.UseInMemoryDatabase("Testing"));
            ...
            services.AddTransient<DataAccess.IAppContext, DataAccess.AppContext>();
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            if (env.IsDevelopment())
            {
                ...
                app.UseSwagger();
                app.UseSwaggerUI(c => c.SwaggerEndpoint("/swagger/v1/swagger.json", "TrueHome v1"));
            }
